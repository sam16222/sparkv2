...
|Use of syntax checkers. | 3 | Syntax checker can be found [here](https://github.com/SiddarthR56/spark/blob/main/.github/workflows/lint.yml) |
|Use of code coverage | TODO | |
|Other automated analysis tools| TODO |  |
|Test cases exist| TODO |  |
|Test cases are routinely executed| TODO | |
